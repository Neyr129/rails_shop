...
u1 = User.create({name: "Sally", email: "sally@example.com", encrypted_password: "1",  role_id: r1.id})
u2 = User.create({name: "Sue", email: "sue@example.com", encrypted_password: "1",     role_id: r2.id})
u3 = User.create({name: "Kev", email: "kev@example.com", encrypted_password: "1",   role_id: r2.id})
u4 = User.create({name: "Jack", email: "jack@example.com", encrypted_password: "1",   role_id: r3.id})
